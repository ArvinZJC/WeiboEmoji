...
1. 截至 2023 年 3 月 5 日，使用 Visual Studio Code（版本：1.76.0）和 Python 3.9 开发表现良好。此更新检查器主要的包参见下面的表格。更多信息请参见[在更新检查器的 `src` 目录下的 `requirements.txt`](./src/requirements.txt)。
