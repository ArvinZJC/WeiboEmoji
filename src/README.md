...
1. By 26 February 2023, everything looks good with Visual Studio Code (Version: 1.75.1) + Python 3.11.1. The primary packages of Part 2 are listed in the following table. For more info, please refer to [`requirements.txt`](./requirements.txt).
