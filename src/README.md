...
1. By 4 April 2022, everything looks good with Visual Studio Code (Version: 1.66.0) + Python 3.10.2. The primary packages of Part 2 are listed in the following table. For more info, please refer to [`requirements.txt`](./requirements.txt).
