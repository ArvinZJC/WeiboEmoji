...
1. By 2 July 2022, everything looks good with Visual Studio Code (Version: 1.68.1) + Python 3.10.4. The primary packages of Part 2 are listed in the following table. For more info, please refer to [`requirements.txt`](./requirements.txt).
