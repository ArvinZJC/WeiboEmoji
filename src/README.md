...
1. By 25 September 2022, everything looks good with Visual Studio Code (Version: 1.71.2) + Python 3.10.6. The primary packages of Part 2 are listed in the following table. For more info, please refer to [`requirements.txt`](./requirements.txt).
