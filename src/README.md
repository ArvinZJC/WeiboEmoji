...
1. The helper scripts are licensed under [the GPL-3.0 License](../LICENSE). By 29 April 2022, everything looks good with Visual Studio Code (Version: 1.66.2) + Python 3.10.2. The primary packages of Part 2 are listed in the following table. For more info, please refer to [`requirements.txt`](./requirements.txt).
