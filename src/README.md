...
1. By 21 October 2022, everything looks good with Visual Studio Code (Version: 1.72.2) + Python 3.10.8. The primary packages of Part 2 are listed in the following table. For more info, please refer to [`requirements.txt`](./requirements.txt).
