...
1. 工具脚本使用 [GPL-3.0 协议](../LICENSE)。截至 2022 年 4 月 29 日，使用 Visual Studio Code（版本：1.66.2）和 Python 3.10.2 开发表现良好。第 2 部分主要的包参见下面的表格。更多信息请参见 [`requirements.txt`](./requirements.txt)。
