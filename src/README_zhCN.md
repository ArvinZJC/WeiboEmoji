...
1. 工具脚本使用 [GPL-3.0 协议](../LICENSE)。截至 2022 年 4 月 7 日，使用 Visual Studio Code（版本：1.66.0）和 Python 3.10.2 开发表现良好。第 2 部分主要的包参见下面的表格。更多信息请参见 [`requirements.txt`](./requirements.txt)。
...
2. 您可以在 `src` 目录下手动创建名为 `.env` 或 `.env.local` 的文件，并包含如下内容。请注意这个操作 _可选_。**在没有这个文件的情况下，此项目应仍能良好运行**。
